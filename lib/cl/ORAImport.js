            ...
            if (out.blend === 'svg:multiply') {
                ...
                for (let y = min_y; y < max_y; ++y) {
                    ...
                    for (let x = min_x; x < max_x; ++x) {
                        ...
                        const c = 1 / 255;
                        r = ((255 - alpha_blend) + (c * r * alpha_blend)) | 0;
                        g = ((255 - alpha_blend) + (c * g * alpha_blend)) | 0;
                        b = ((255 - alpha_blend) + (c * b * alpha_blend)) | 0;

//                        r = (255 - (((255 - r) * alpha_blend) / 255)) | 0;
//                        g = (255 - (((255 - g) * alpha_blend) / 255)) | 0;
//                        b = (255 - (((255 - b) * alpha_blend) / 255)) | 0;
...
//            postProcessState(serialized_state);
