            ...
            for (let i = len - 1; i >= 0; --i) {
                ...
                if (child.visible === true) {
                    ...
                    if (child.type === 'layer') {
                        ...
                        const mesh = threejs_cache[child.uid].mesh;
...
//                needs_renderer_cleanup = true;
        ...
        const blend_normal_inherit_alpha_mat = new THREE.MeshBasicMaterial({
            map: webgl_render_target.texture,
            depthTest: false,
            depthWrite: false,
            transparent: true,
        ...
        const blend_multiply_mat = new THREE.MeshBasicMaterial({
            map: webgl_render_target.texture,
            depthTest: false,
            depthWrite: false,
            transparent: true,
        ...
        const blend_normal_inherit_alpha_mesh =
                        new THREE.Mesh(geom, blend_normal_inherit_alpha_mat);
        const blend_multiply_mesh = new THREE.Mesh(geom, blend_multiply_mat);
        ...
        const ctarget = {
            ...
            geom,
            blend_normal_mesh,
            blend_normal_inherit_alpha_mesh,
            blend_multiply_mesh,
            ...
            resize: (w, h) => {
                ...
                ctarget.blend_multiply_mesh = new THREE.Mesh(geom, blend_multiply_mat);
            }
        };
