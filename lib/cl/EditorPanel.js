...
//                        color: 0x0ff4020,
                ...
                CompositingHelper.setMaterialForBlendMode(present_material, layer_blend);
                const present_mesh = new THREE.Mesh( present_geometry, present_material );
                ...
                CompositingHelper.setMaterialForBlendMode(pose_material, layer_blend);
                const pose_mesh = new THREE.Mesh( pose_geometry, pose_material );
                ...
                threejs_cache[layer.get('uid')] = {
                    texture,
                    present_mesh, present_geometry,
                    pose_mesh, pose_geometry
                };
