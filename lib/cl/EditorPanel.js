...
//                    active_mesh_editing.selected_vertex_uid, now_r.x, now_r.y);
    ...
    function handleActionsListChange(evt) {
        ...
        if (type === 'controlmove') {
            ...
            // PENDING
            console.log("COMPLETE UPDATE: %s %s", evt.name, evt.value);
        }
    }
    ...
    function handleActionsListItemSelect(evt) {
        ...
        if (type === 'controlselect') {
            console.log("ACTION LIST SELECT: %s %s", evt.name, evt.uid);
        }
        else if (type === 'controlunselect') {
            console.log("ACTION LIST UNSELECT: %s %s", evt.name, evt.uid);
        }
    }
