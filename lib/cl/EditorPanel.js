...
//        camera.needsUpdate = true;
    ...
    function getTextureLayersTreeModel() {
        ...
        if (texture_layers.isDefined()) {
            ...
            // // The meshes branch
            // out.push({ type:'branch', path:[], name:'Meshes' });
            // // PENDING: Meshes...
            //
    ...
    function getMeshControlTreeModel() {
        ...
        if (meshes.isDefined()) {
            ...
            out.push(
                { type:'branch', path:[], name:'Deformers' }
            );
            // PENDING:
...
//                console.log("OPACITY: %s", layer_opacity);
...
//        console.log(evt);
    ...
    function handleMeshesDrop(evt) {
        ...
        const mesh_ob = getMeshFromUid(drop_target_uid);
            ...
            if (layer_type === 'layer') {
                ...
                if (layer_ob !== undefined) {
                    ...
                    if (mesh_uid_for_layer === undefined) {
                        ...
                        layer_ob.set('mesh_uid_for_layer', drop_target_uid);
