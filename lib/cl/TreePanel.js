...
//    const ENTRY_HEIGHT = 20;
    ...
    tree_view_root.addEventListener('mousedown', (evt) => {
        ...
        if (target) {
            ...
            let selected_ele = target;
            let down_on_path = target.vanim_layer_uid;
            if (down_on_path === undefined) {
                selected_ele = target.parentNode;
                down_on_path = target.parentNode.vanim_layer_uid;
            }
            if (down_on_path !== undefined) {
                // Select this,
                ...
                selected_elements.push(down_on_path);
                selected_ele.parentNode.classList.add('selected');
