...
`;
    ...
    function createPreMultAlphaMaterial() {
        ...
        return new THREE.ShaderMaterial({
            ...
            vertexShader: std_vertex_shader_glsl,
            fragmentShader: `
...
void main() {
    ...
    // Add color if needed (needs premultiplied alpha),
//    tcolor = tcolor + vec4(color_add, 0);
    tcolor.rgb += (color_add * tcolor.a);
