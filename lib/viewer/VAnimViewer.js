...
function ModelTarget(filename, ss, renderer) {
    ...
    function refreshPoseFromActions() {
        // Calculate mesh deforms from all other actions,
        const all_mesh_deforms =
                composition_controller.calcMeshMorphsFromActions(ss, []);
        ...
        for (let mesh_uid in all_mesh_deforms) {
            ...
            const vertex_arr =
                    composition_controller.toVertexArr(deform.vertex_map);
